...
export const vestingSeed1 = [
  ...
  },
  {
    ...
    initialClaimed: false,
    claimStartTime: 1648101600 + 15552000, // 10 Mar 2022 + 180 days
    exists: true
  },
  {
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("350000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("45000000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
...
export const vestingSeed2 = [
  {
    ...
    vestingAmount: ethers.utils.parseEther("73000000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("750000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("37641"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("5228"),
    initialClaimed: false,
    claimStartTime: 1648101600 + 12960000, // 10 Mar 2022 + 150 days
    exists: true
  },
  {
    beneficiary: "0x993B8FB52c3f209AE9270AB6F3fe8c272a10f9CE",
    vestingAmount: ethers.utils.parseEther("536937"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("147510"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("22537"),
    initialClaimed: false,
    claimStartTime: 1648101600 + 14256000, // 10 Mar 2022 + 165 days
    exists: true
  },
  {
    beneficiary: "0x3fD14DCfff0ccd2d453BCAdde95c87c736d693Dd",
    vestingAmount: ethers.utils.parseEther("1150578"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
    initialAmount: ethers.utils.parseEther("159802"),
    initialClaimed: false,
    claimStartTime: 1648101600 + 12960000, // 10 Mar 2022 + 150 days
    exists: true
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("191763"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("498584"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("52447"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("1534104"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("87947"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("834376"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("3627999"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("76705"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("383526"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("30000000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("3451735"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("16108095"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
...
export const vestingSeed3 = [
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("875000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
  ...
  },
  {
    ...
    vestingAmount: ethers.utils.parseEther("10000000"),
    duration: "93312000", // 36 months in seconds which is 60*60*24*30*36
    claimedAmount: 0,
    lastClaimedTime: 0,
